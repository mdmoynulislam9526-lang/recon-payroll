        ...
        with tab1:
            ...
            if pay_search:
                ...
                if pay_results:
                    ...
                    # --- PAYSLIP PREVIEW: NATIVE HTML SYSTEM (ONLY THE LOGO IMAGE) ---
                    logo_img_tag = f"<img src='data:image/png;base64,{logo_base64_str}' style='max-height: 95px; width: auto; display: block; margin: 0 auto; background: transparent; mix-blend-mode: multiply;'>" if logo_base64_str else ""
                    ...
                    <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 25px; background: white; color: black; border: 1px solid #e0e0e0; border-radius: 12px; max-width: 650px; margin: 15px auto; box-sizing: border-box; box-shadow: 0 4px 20px rgba(0,0,0,0.07);">
                        ...
                        <div style="text-align: center; margin-bottom: 15px; border-bottom: 2.5px solid #1F4E78; padding-bottom: 12px; background: transparent;">
                            {logo_img_tag}
                        </div>
        ...
        with tab2:
            ...
            <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 25px; background: white; color: black; border-radius: 8px;">
                ...
                <div style="text-align: center; margin-bottom: 15px; border-bottom: 3.5px solid #1F4E78; padding-bottom: 12px;">
                    {"<img src='data:image/png;base64," + logo_base64_str + "' style='max-height: 95px; width: auto; display: block; margin: 0 auto; mix-blend-mode: multiply;'>" if logo_base64_str else ""}
