...
for cat_name, title_text in zip(categories_list, display_titles):
                ...
                for r in cat_rows:
                    ...
                    gross, house_rent, medical, _, ab_cut, net_p, adv_paid = calculate_salary_breakdown(base_sal, rec['absent_days'], rec['fine_cut'], cat, rec['present_days'], rec['advance_cut'])
